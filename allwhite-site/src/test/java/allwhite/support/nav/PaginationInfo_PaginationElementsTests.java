...
public class PaginationInfo_PaginationElementsTests {
    ...
    @Test
    public void rendersFirstSixPagesOnPageOne_givenEnoughNumberOfPages() {
    ...
    @Test
    public void rendersFirstSixPagesOnPageThree_givenEnoughNumberOfPages() {
    ...
    @Test
    public void rendersCurrentPage() {
        int currentPageIndex = 2;
