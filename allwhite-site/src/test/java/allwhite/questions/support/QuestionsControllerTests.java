...
public class QuestionsControllerTests {
    ...
    public void setUp() {
        ...
        given(projectMetadataService.getProjects()).willReturn(Arrays.asList(
                ...
                new Project("spring-data-mongodb", "Spring Data MongoDB", null, null, 1,
                        Collections.emptyList(), "active", "", ""),
                new Project("spring-data-graph", "Spring Data Graph", null, null, 1,
                        Collections.emptyList(), "attic", "", ""),
                new Project("spring-scala", "Spring Scala", null, null, 2,
                        Collections.emptyList(), "incubator", "", "")));
    ...
    public void index() throws Exception {
        ...
        assertThat(((List<Question>) model.get("questions")).stream()
                ...
                .collect(Collectors.toList()), contains("Question 1", "Question 2"));

        assertThat(((List<Project>) model.get("projects")).stream()
                .map(Project::getName)
                .collect(Collectors.toList()), contains("Spring Data", "Spring Framework"));
    }
}
