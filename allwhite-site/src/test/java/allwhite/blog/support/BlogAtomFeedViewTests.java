...
public class BlogAtomFeedViewTests {
    ...
    public void hasLinkToAssociatedBlogList() {
        ...
        Link feedLink = feed.getAlternateLinks().get(0);
    ...
    @Test
    public void feedUpdatedDateIsMostRecentPublishedPostDate() {
    ...
    @Test
    public void feedUpdateDateIsNotPresentWhenThereAreNoPosts() {
