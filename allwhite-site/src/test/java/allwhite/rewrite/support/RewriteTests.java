package allwhite.rewrite.support;

import allwhite.UrlRewriterFilterConfig;
...
public class RewriteTests {
    ...
    public void setUp() throws ServletException {
        UrlRewriteFilter filter = createUrlFilter(UrlRewriterFilterConfig.REWRITE_FILTER_NAME,
    ...
    @Test
    public void rossensWebSocketPostIsRedirectToOldBlog() throws ServletException, IOException, URISyntaxException {
    ...
    private void validatePermanentRedirect(String requestedUrl, String redirectedUrl) throws ServletException, IOException, URISyntaxException {
        validateRedirect(requestedUrl, redirectedUrl, 301);
    }

    private void validateTemporaryRedirect(String requestUrl, String redirectUrl) throws ServletException, IOException, URISyntaxException {
        validateRedirect(requestUrl, redirectUrl, 302);
    }

    private void validateRedirect(String requestedUrl, String redirectedUrl, int expectedStatus) throws URISyntaxException, IOException, ServletException {
        MockHttpServletRequest servletRequest = new MockHttpServletRequest();
        URI requestUrl = new URI(requestedUrl);
        if (requestUrl.getHost() != null) {
            servletRequest.addHeader("host", requestUrl.getHost());
