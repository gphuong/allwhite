...
public class DocsWebhookControllerTests {
    ...
    public void testInvalidHmacValue() {
    ...
    @Test
    public void testGuideWebhookPing() throws IOException {
    ...
    @Test
    public void testGuideCacheEviction() throws IOException {
        String payload = StreamUtils.copyToString(
    ...
    @Test
    public void testGuideCacheEviction2() throws IOException {
        String payload = StreamUtils.copyToString(
                new ClassPathResource("fixtures/webhooks/docsWebhook.json").getInputStream(), Charset.forName("UTF-8")).replaceAll("[\\n|\\r]", "");

        ResponseEntity response = this.controller.processGuidesUpdate(payload,
                "sha1=848E37804A9EC374FE1B8596AB25B15E98928C98", "push",
                "gs-test-guide");
        assertThat(response.getBody(), is("{ \"message\": \"Successfully processed update\" }\n"));
        assertThat(response.getStatusCode().value(), is(200));
        verify(this.gettingStartedGuides, times(1)).evictFromCache("test-guide");
    ...
    @Test
    public void testTutorialCacheEviction() throws IOException {
        String payload = StreamUtils.copyToString(
                new ClassPathResource("fixtures/webhooks/docsWebhook.json").getInputStream(), Charset.forName("UTF-8"))
                .replaceAll("[\\n|\\r]", "");

        ResponseEntity response = this.controller.processTutorialsUpdate(payload,
                "sha1=848E37804A9EC374FE1B8596AB25B15E98928C98", "push");
        assertThat(response.getBody(), is("{ \"message\": \"Successfully processed update\" }\n"));
        assertThat(response.getStatusCode().value(), is(200));
    ...
    @Test
    public void testTutorialCacheEviction2() throws IOException {
        String payload = StreamUtils.copyToString(new ClassPathResource("fixtures/webhooks/docsWebhook.json").getInputStream(), Charset.forName("UTF-8"))
                .replaceAll("[\\n|\\r]", "");

        ResponseEntity response = this.controller.processTutorialsUpdate(payload, "sha1=848E37804A9EC374FE1B8596AB25B15E98928C98",
                "push",
                "gs-test-guide");
        assertThat(response.getBody(), is("{ \"message\": \"Successfully processed update\" }\n"));
        assertThat(response.getStatusCode().value(), is(200));
    ...
    @Test
    public void testTopcicalCacheEviction() throws IOException {
        String payload = StreamUtils.copyToString(
                new ClassPathResource("fixtures/webhooks/docsWebhook.json").getInputStream(), Charset.forName("UTF-8"))
                .replaceAll("[\\n|\\r]", "");
