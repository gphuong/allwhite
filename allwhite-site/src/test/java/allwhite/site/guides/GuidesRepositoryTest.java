...
@RestClientTest({GettingStartedGuides.class, AllwhiteRendererClient.class, SiteProperties.class})
@TestPropertySource(properties = "allwhite.site.renderer.service-url=https://example.com/")
public class GuidesRepositoryTest {
    ...
    private ClassPathResource getClassPathResource(String path) {
        return new ClassPathResource(path, AllwhiteRendererClient.class);
    }
}
