...
public class PostFormAdapter_CreatePostTests {
    public static final String RENDERED_HTML = "<p>Rendered HTML</p>from Markdown</p>";
    ...
    @Test
    public void postCreatedDateDefaultsToNow() {
        assertThat(post.getCreatedAt(), is(now));
    }

    @Test
    public void postCreatedDateCanBeSetFromAPostForm() {
