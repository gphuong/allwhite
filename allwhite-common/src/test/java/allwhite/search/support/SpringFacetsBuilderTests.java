...
public class SpringFacetsBuilderTests {
    ...
    @Test
    public void addsAnEmptyProjectsFacetIfNotInTheOriginalFacets() {
    ...
    @Test
    public void movesProjectPageToBeAHeaderFacetUnderProjects() {
    ...
    @Test
    public void movesApiToBeAHeaderFacetUnderProjects() {
    ...
    @Test
    public void movesReferenceToBeAHeaderFacetUnderProjects() {
        facets.add(projects);
