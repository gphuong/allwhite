...
public class ProjectTest {
    ...
    ProjectRelease currentRelease =
            new ProjectRelease("1.8.7.RELEASE", GENERAL_AVAILABILITY, true, "ref-doc-url",
                    "api-doc-url", "group-id", "artifact-id");
    ProjectRelease olderRelease =
            new ProjectRelease("2.0.0.RELEASE", GENERAL_AVAILABILITY, false, "ref-doc-url",
                    "api-doc-url", "group-id", "artifact-id");

    @Before
    public void setup() {
        List<ProjectRelease> releases = asList(currentRelease, olderRelease);
        project = new Project("id", "my-special-project", "my-repo-url", "my-site-url", releases, "my-special-category");
    }
    ...
    public void orderedProjectSample() {
