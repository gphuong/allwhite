...
public class ToolSuiteTests {
    @Test
    public void testPreferredDownloadLinks() {
    ...
    private ToolSuiteDownloads buildToolSuite() {
        ...
        architecture = "64";
        linux64Links.add(new DownloadLink("http://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-linux-gtk-x86_64.tar.gz",
                "tar.gz", "323MB", os, architecture));
