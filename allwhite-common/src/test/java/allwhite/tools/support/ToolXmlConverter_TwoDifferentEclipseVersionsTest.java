...
public class ToolXmlConverter_TwoDifferentEclipseVersionsTest {
    ...
    @Test
    public void addTheMacPlatform() {
        assertThat(toolSuite.getPlatformList().get(1).getName(), equalTo("Mac"));
    }

    @Test
    public void addBothEclipseVersionsToThePlatform() {
    ...
    @Test
    public void addsAnArchitectureToEachEclipseVersion() {
        ToolSuitePlatform mac = toolSuite.getPlatformList().get(1);
    ...
    @Test
    public void addsADownloadLinkTheArchitectureInEachPlatform() {
        ...
        assertThat(v43Architecture.getDownloadLinks().get(0).getUrl(),
        ...
        assertThat(v38Architecture.getDownloadLinks().get(0).getUrl(),
