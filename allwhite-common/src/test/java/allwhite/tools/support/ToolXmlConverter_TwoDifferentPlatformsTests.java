...
public class ToolXmlConverter_TwoDifferentPlatformsTests {
    ...
    @Test
    public void addsAnEclipseVersionToEachPlatform() {
    ...
    @Test
    public void addsAnArchitectureToTheEclipseVersionInEachPlatform() {
    ...
    public void addsADownloadLinkTheArchitectureInEachPlatform() {
        ...
        assertThat(windowsArchitecture.getDownloadLinks().get(0).getUrl(),
