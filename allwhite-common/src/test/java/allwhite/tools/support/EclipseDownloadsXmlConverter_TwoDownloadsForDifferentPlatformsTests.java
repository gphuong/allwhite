...
public class EclipseDownloadsXmlConverter_TwoDownloadsForDifferentPlatformsTests {
    ...
    @Test
    public void addsAProductToEachPlatform() {
    ...
    public void addsTwoPackages() {
        List<EclipsePackage> macPackages = eclipseDownloads.getPlatforms().
                get("mac").getReleases().get(0).getPackages();
        assertThat(macPackages.size(), equalTo(1));
        assertThat(macPackages.get(0).getName(), equalTo("Eclipse Standard 4.3"));

        List<EclipsePackage> windowsPackages = eclipseDownloads.getPlatforms().get("windows").getReleases().
                get(0).getPackages();
    ...
    @Test
    public void addsDownloadLinksToTheArchitectures() {
        ...
        assertThat(macDownloadLinks.get(0).getUrl(),
        ...
        assertThat(windowsDownloadLinks.get(0).getUrl(),
