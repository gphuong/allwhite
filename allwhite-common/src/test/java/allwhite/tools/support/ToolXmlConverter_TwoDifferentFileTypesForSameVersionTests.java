...
public class ToolXmlConverter_TwoDifferentFileTypesForSameVersionTests {
    ...
    @Test
    public void addsTheMacPlatform(){
        assertThat(toolSuite.getPlatformList().get(1).getName(),equalTo("Mac"));
    }

    @Test
    public void addsAnEclipseVersionToThePlatform(){
    ...
    @Test
    public void addsAnArchitectureToTheEclipseVersion(){
        ToolSuitePlatform platform = toolSuite.getPlatformList().get(1);
    ...
    public void addsADownloadLinkTheArchitecture(){
        ...
        assertThat(architecture.getDownloadLinks().get(1).getUrl(),
