...
public class PostTests {
    ...
    public void slugReplacesMultipleSpacesWithASingleDash() {
        assertEquals("1-title-1-with-characters",
                builder.title("Title 1, with characters';:\\|").build().getAdminSlug());
    }

    @Test
    public void slugStripsNonAlphanumericCharacters() {
        assertEquals("1-title-with-characters", builder.title("Title 1, with characters';:\\|").build()
                .getAdminSlug());
    }
    ...
    public void isNotLiveIfDraft() throws ParseException {
        ...
        assertThat(post.isLiveOn(new SimpleDateFormat("yyyy-MM-dd HH:mm").
                parse("2014-06-28 00:00")), is(false));
    }
    ...
    public void isNotLiveIfScheduledInTheFuture() throws ParseException {
        ...
        assertThat(post.isLiveOn(new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2013-06-28 00:00")),
                is(false));
    }

    @Ignore("TODO: implement this at some point")
    @Test
    public void isScheduledIfPublishDateIsInTheFuture() {
